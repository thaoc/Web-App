...
<!--	<div class="wrapper"> -->
		...
		<h3 class="green">Current Location:</h3>
			...
			<label class="highlight" for="currentLocPlannerChck">Information matches planner: </label><br>
			<input type="radio" name="currentLocPlannerChck" value="yes" onclick="noUpdate();">Yes <br>
			<input type="radio" name="currentLocPlannerChck" value="no" onclick="updatePlanner();">No
